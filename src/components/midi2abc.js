...
let section;
let sectionEnd;
export default function midi2abc(ns, options) {
...
function toneMidiToNoteSequence(midi) {
  // midi.tracks is an array of tracks, each with notes
  const notes = [];
  ...
  // Return NoteSequence-like object
  return {
    notes,
    tempos,
    totalTime,
